...
- **ในรอบนี้มีอะไรซ้ำกันบ้าง** → ตั้งตัวกรองเป็น 7 หรือ 14 วัน แล้วดูรายงานหัวข้อซ้ำ + เนื้อหาคล้าย
- **หัวข้อนี้มีแล้วไหม / เว็บไหนเขียนไปแล้ว** → แสดงในตารางแต่ละรายการ (sources)
- **ต้องการดูย้อนหลัง** → เลือก 30 วัน หรือ "ทั้งหมด"

### ช่องทางที่ใช้
- **Dashboard (เว็บ):** หัวข้อบทความแนะนำ, รายงานบทความซ้ำ
- **CLI:** `npm run scan` | `npm run detect`
